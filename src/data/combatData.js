// Combat data scraped from sparkingzeroteambuilder.com
// Key structure: combatData[characterName][formName]
...
export const combatData = {
  ...
  "Goku (Z-End)": {
    ...
    "Super Saiyan 2": {
      ...
      "skill2": "Full Power",
      "super1": {
        "name": "Instant TransmissionKamehameha",
        "damage": 8550
      },
      "super2": {
        "name": "Meteor Crash",
    ...
    "Super Saiyan 3": {
      ...
      "rush5": 3197,
      "skill1": "Instant Transmission",
      "skill2": "Power up to the very limit",
      "super1": {
        "name": "Super Kamehameha",
        "damage": 8905
      },
  ...
  "Goku (Super UI)": {
    "Ultra Instinct -Sign-": {
      ...
      "rush1": 527,
      "rush5": 3485,
      "skill1": "Even Greater Potential",
      "skill2": "You'll never beat me",
      "super1": {
    ...
    "Ultra Instinct": {
      ...
      "rush1": 546,
      "rush5": 3801,
      "skill1": "Ultra Movement",
      "skill2": "No backing down",
      "super1": {
  ...
  "Goku (GT)": {
    ...
    "Super Saiyan 4": {
      ...
      "rush5": 3249,
      "skill1": "Instant Transmission",
      "skill2": "All I need is five seconds!",
      "super1": {
        "name": "x10 Kamehameha",
        "damage": 9260
      },
  ...
  "Goku (Teen)": {
    "Base": {
      ...
      "rush1": 371,
      "rush5": 2339,
      "skill1": "Afterimage Strike",
      "skill2": "False Courage",
      "super1": {
        "name": "Kamehameha",
        "damage": 6795
      },
  ...
  "Majin Vegeta": {
    "Base": {
      ...
      "rush1": 488,
      "rush5": 3077,
      "skill1": "Prince's Pride",
      "skill2": "Majin's Awakening",
      "super1": {
        "name": "Final Impact",
        "damage": 8125
      },
  ...
  "Vegeta (Super)": {
    ...
    "Super Saiyan Blue": {
      ...
      "rush1": 515,
      "rush5": 3328,
      "skill1": "I'm No Pushover!",
      "skill2": "Limits?! I break them!",
      "super1": {
  ...
  "Gohan (Kid)": {
    "Base": {
      ...
      "rush1": 371,
      "rush5": 2339,
      "skill1": "Super Unyielding Spirit",
      "skill2": "Afterimage Strike",
      "super1": {
        "name": "Masenko",
        "damage": 6765
  ...
  "Trunks (Kid)": {
    ...
    "Super Saiyan": {
      ...
      "rush5": 3077,
      "skill1": "Explosive Wave",
      "skill2": "Super Unyielding Spirit",
      "super1": {
        "name": "Full-Power Energy Wave",
        "damage": 8190
      },
  ...
  "Super Gogeta (Z)": {
    "Base": {
      ...
      "rush1": 519,
      "rush5": 3274,
      "skill1": "Immovable Stance",
      "skill2": "I'm the one who will defeat you!",
      "super1": {
  ...
  "Frieza (Z)": {
    ...
    "4th Form": {
      ...
      "rush5": 2706,
      "skill1": "Psychokinesis",
      "skill2": "Your arrogance disgusts me!",
      "super1": {
        "name": "Barrage Death Beam",
        "damage": 7960
      },
  ...
  "Captain Ginyu": {
    "Base": {
      ...
      "rush1": 390,
      "rush5": 2460,
      "skill1": "SP Fighting Pose 5",
      "skill2": "Dangerous Shock",
      "super1": {
        "name": "Full-Power Energy Wave",
        "damage": 7125
      },
  ...
  "Android 16": {
    "Base": {
      "class": "Infinite Ki Android (Power)",
      "defense": 873,
      "switchTime": "23s",
      "meleeDmg": 2259,
      "kiBlastDmg": 225,
  ...
  "Android 17 (Z)": {
    "Base": {
      "class": "Infinite Ki Android (Ki-Blast)",
      "defense": 1049,
      "switchTime": "23s",
      "meleeDmg": 2713,
      "kiBlastDmg": 300,
  ...
  "Turles": {
    "Base": {
      ...
      "rush5": 2214,
      "skill1": "Explosive Wave",
      "skill2": "Fruit of the tree of might",
      "super1": {
        "name": "Kill Driver",
        "damage": 7125
      },
  ...
  "Spopovich": {
    "Base": {
      ...
      "rush1": 410,
      "rush5": 2585,
      "skill1": "A servant's latent power",
      "skill2": "Berserker",
      "super1": {
  ...
  "Dyspo": {
    "Base": {
      ...
      "rush1": 410,
      "rush5": 2585,
      "skill1": "Super Maximum Light Speed Mode",
      "skill2": "Pride Trooper Pose 2",
      "super1": {
  ...
  "Ribrianne": {
    "Base": {
      ...
      "rush1": 468,
      "rush5": 2952,
      "skill1": "Light of Love",
      "skill2": "Maiden's Fury",
      "super1": {
        "name": "Pretty Cannon",
        "damage": 7124
      },
  ...
  "Gamma 1": {
    "Base": {
      ...
      "rush1": 410,
      "rush5": 2585,
      "skill1": "Gamma Super Hero Pose 1",
      "skill2": "Android Barrier",
      "super1": {
        "name": "Gamma Blaster",
        "damage": 8194
      },
  ...
  "Gohan (Super Hero)": {
    ...
    "Ultimate Gohan": {
      ...
      "rush5": 3203,
      "skill1": "Wild Sense",
      "skill2": "The Power to Rise Again",
      "super1": {
  ...
  "Piccolo (Super Hero)": {
    ...
    "Power Awakening": {
      ...
      "rush5": 2955,
      "skill1": "Wild Sense",
      "skill2": "This Won't End the Same Way",
      "super1": {
        "name": "Explosive Ruin",
        "damage": 8551
      },
  ...
  "Gamma 2": {
    "Base": {
      ...
      "rush1": 410,
      "rush5": 2585,
      "skill1": "Gamma Super Hero Pose 2",
      "skill2": "Android Barrier",
      "super1": {
        "name": "Gamma Blaster",
        "damage": 8194
  ...
  "Vegeta (Mini)": {
    ...
    "Super Saiyan 3": {
      ...
      "rush5": 3127,
      "skill1": "Wild Sense",
      "skill2": "Special Training Results",
      "super1": {
        "name": "Slash Flash",
        "damage": 6500
      },
  ...
  "Third Eye Gomah": {
    ...
    "Giant Gomah": {
      ...
      "rush1": 683,
      "rush5": 5310,
      "skill1": "Third Eye Heal",
      "skill2": "Third Eye Enhance",
      "super1": {
        "name": "Magic Missle",
        "damage": 0
      },
...
// Form name mapping: Reference site "Normal" class maps to our "Base" form
// Use getCombatData(characterName, formName) for lookup
export function getCombatData(charName, formName) {
  const charData = combatData[charName]
  if (!charData) return null
  return charData[formName] || charData['Base'] || null
}

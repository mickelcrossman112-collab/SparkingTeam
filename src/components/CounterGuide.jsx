...
function analyzeEnemy(char) {
  ...
  if (!allTraits.has('Health Regeneration')) weaknesses.push('No Health Regen — damage sticks')
  if (!allTraits.has('Unblockable Ultimate')) weaknesses.push('No Unblockable Ultimate')
...
function scoreCounter(counterChar, enemyAnalysis) {
  ...
  if (enemyAnalysis.allTraits.has('Dodge Skill') && allSkills.has('Super Explosive Wave')) score += 4
  ...
  if (enemyAnalysis.peakKi > 3500 && allTraits.has('Dodge Skill')) score += 3
